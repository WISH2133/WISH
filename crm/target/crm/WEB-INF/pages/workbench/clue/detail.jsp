			...
			$.ajax({
				...
				success:function (data) {
					if (data.code=="1"){
						...
						//刷新已经关联的市场活动列表
						var htmlStr="";
						$.each(data.retData,function (index,obj) {  //data.retData->activityList
...
<body>
	...
	<div>
		<div style="position: relative; top: 60px; left: 40px;">
			...
			<div>
				<a id="bundActivityBtn" href="javascript:void(0);" style="text-decoration: none;"><span class="glyphicon glyphicon-plus"></span>关联市场活动111</a>
			</div>
		</div>
	</div>

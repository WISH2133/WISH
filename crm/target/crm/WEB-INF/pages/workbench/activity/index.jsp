...
<script type="text/javascript">
	...
	$(function(){
        ...
        $("#editActivityBtn").click(function(){
            ...
            $.ajax({
                ...
                type:'post',
                dataType:'json',
                success:function (data) { //activity
                    //把市场活动的信息设置到form表单中
                    $("#edit-id").val(data.id);
		...
		$("#importActivityBtn").click(function () {
			...
			$.ajax({
				  ...
				  type:'post',
				  dataType:'json',
				  //会将所有的参数当成字符串，上传是多文件的格式
				  processData:false,
				  //会将所有的参数统一做urlencode编码
				  contentType:false,
				  success:function (data) {
	...
	function queryActivityForPageByCondition(pageNo,pageSize){
		...
		$.ajax({
			url:'workbench/activity/queryActivityForPageByConditon.do',
			data:{
				pageNo:pageNo,
				pageSize:pageSize,
				name:name,
			...
			type:'post',
			dataType:'json',
			success:function(data){ //retMap(activityList,totalRows)

	...
	<script type="text/javascript">
		$(function () {
			...
			$("#deleteDicTypeBtn").click(function () {
				...
				var codesStr=""; //String[] codes
				//code=stage&code=source&code=clueState
				//code=appellation&code=clueState&code=returnState&
				//alert(chkedCodes.size());
				//java this 当前对象，数组有三个对象，每个对象都是复选框，复选框对象.value->$("#id").value
			...
			$("#editDicTypeBtn").click(function () {
				// alert("edit");
				var chkedCodes=$("#tBody input[type='checkbox']:checked"); //数组：包含被选中复选框
				//alert(chkedCodes.size());
				if(chkedCodes.size()==0){
					alert("请选择要编辑的记录");
					return;
				...
				//alert(code);
				//jsp get post get->http://localhost:8080/crm?username="tom"&password="123"
